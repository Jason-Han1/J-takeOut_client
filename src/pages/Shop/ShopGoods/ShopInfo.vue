  ...
  <div class="shop-info" ref="info">
    <div class="info-content">
      <section class="section">
        <h3 class="section-title">{{info.description}}</h3>
        <div class="delivery">
          <div>
      ...
      <section class="section">
        ...
        <div class="pic-wrapper" ref="pics">
          <ul class="pic-list" ref="ul">
            <li class="pic-item" v-for="pic in info.pics" ref="li">
  ...
  export default {
    ...
    methods:{
      setUlWidth() {
        ...
        const space = 6
        const li = document.getElementsByClassName('pic-item')[0]
        const liWidths = ((li.offsetWidth+space) * this.info.pics.length) - space + 'px'
        ul.style.width = liWidths
      }
    },
    components: {
      Star
